...
IT_PROMPT = """You are an expert IT Support specialist with deep knowledge of:
...
MARKETING_PROMPT = """You are a strategic Digital Marketing expert specializing in:
...
CONTENT_PROMPT = """You are a versatile Content Writer skilled in:
...
DESIGN_PROMPT = """You are a creative Graphic/Web Designer expert in:
- UI/UX design
- Brand identity
...
FINANCE_PROMPT = """You are a precise Financial Analyst specializing in:
...
EMBEDDED_PROMPT = """You are an Embedded Systems Engineer expert in:
...
MOBILE_PROMPT = """You are a Mobile Development specialist skilled in:
...
LEGAL_PROMPT = """You are a Legal Process expert specializing in:
